...
Rest:
Cook:
Source1: https://debraklein.com/veggie-spring-rolls-with-peanut-sauce/#recipe
Source2: https://www.poormanprotein.com/recipes/peanut-chili-salad-dressing
Source3:
Source4:
Source5:
whisk: https://s.samsungfood.com/mcQoV
tags:
- spring rolls
- peanut sauce
...
- |
  ...
  Add a row of <a href='/misc/veggies#radish'>radishes</a>, then the <a href='/misc/veggies#lettuce'>lettuce</a> leaf, along with some <a href='/misc/veggies#cabbage'>cabbage</a>, <a href='/misc/veggies#carrots'>carrot</a>, <a href='/misc/veggies#pepper'>pepper</a>, and cilantro.<br><br>
...
- <img src='/assets/Food/Finger Food/Spring Rolls/unwrap.jpg' alt='' class='instruction-image'>
- <img src='/assets/Food/Finger Food/Spring Rolls/wrap.jpg' alt='' class='instruction-image'>
...
- |
  COMPARE(
    "springrolls",
    "springrollswithsauce";

    "<a href='#recipe'>As<br>Is</a>",
    "<a href='/recipes/peanut-chili-salad-dressing'>With<br>Sauce</a>";
