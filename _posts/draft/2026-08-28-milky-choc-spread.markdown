...
protein_bar: no
beans: no
permalink: /recipes/milky-chocolate-spread
image: /assets/Food/Meme/Milky Choc Spread/cover.jpg
file: milkychocspread
servingSize:
section1:
start2:
section2:
...
Source4:
Source5:
whisk: https://s.samsungfood.com/L3MSP
tags:
- powdered milk
- skim milk
- chocolate
...
- |
  COMPARE(
    "milkychocspread",
    "milkychocspreadflatbread";

    "<a href='#recipe'>Spread</a><br>Alone",
    "On<br><a href='/recipes/sourdough-flatbread'>Flatbread</a>";
