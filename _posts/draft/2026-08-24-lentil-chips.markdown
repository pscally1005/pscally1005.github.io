...
file: lentilchips
servingSize: 1 oz, 28 g (~TODO chips)
section1: Soak
...
- Bake at 350F for about 20 minutes, or until lightly golden brown, and the surface is set and dry to the touch. Transfer to a <a href='https://amzn.to/4qQNmn2'>cooling rack</a> to fully cool.
- <img src='/assets/Food/Finger Food/Lentil Chips/bake1.jpg' alt='' class='instruction-image'>

- Cut your large <a href='/recipes/tortilla'>tortilla</a> into small triangles, about TODO. Season on the <a href='https://amzn.to/45sRAsB'>cookie sheet</a> with <a href='/misc/olive-oil'>oil</a> and spices.
- <img src='/assets/Food/Finger Food/Lentil Chips/cut.jpg' alt='' class='instruction-image'>

- Return the chips to the oven at 350F for about 15 minutes, mixing halfway, or until golden and crispy but not burnt.
- <img src='/assets/Food/Finger Food/Lentil Chips/bake2.jpg' alt='' class='instruction-image'>

- Transfer to a <a href='https://amzn.to/4qQNmn2'>wire rack</a> to cool completely. They will crisp more as they cool. Store at room temperature for up to 1 week.
Notes:
---
