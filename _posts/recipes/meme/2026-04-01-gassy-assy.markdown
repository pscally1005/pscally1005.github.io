...
section1: Broccoli
start2: Cabbage
section2: Raw Veggies
start3: Navy beans, lightly drained
section3: Beans
start4: Feta cheese
section4: Toppings
start5:
...
Description: |
  ...
  Introducing the gassiest meal ever engineered by modern science: a volatile fusion of raw <a href='/misc/veggies#cabbage'>cabbage</a> and <a href='/misc/veggies#onion'>onion</a>, <a href='/recipes/roasted-vegetables'>roasted broccoli</a>, unapologetically under-rinsed canned <a href='/misc/beans'>beans</a>, <a href='/misc/dairy#mozzarella'>cheese</a>, and sauerkraut. A cruciferous symphony so powerful it should require a safety briefing.<br><br>

  This is not just dinner.<br><br>
  ...
  A 10-foot perimeter will establish itself naturally.<br><br>

  RSVP declined. Future invitations mysteriously lost in the mail.<br><br>

  Side effects may include:
  <ul>
    <li>Audible consequences</li>
    <li>Structural couch displacement</li>
    <li>Immediate respect for personal space</li>
  </ul>

  Technically healthy. Socially catastrophic.<br><br>

  Enjoy responsibly.
Instructions:
- Preheat your oven to 400F, and line a <a href='https://amzn.to/45sRAsB'>cookie sheet</a> with parchment paper. Add your <a href='/misc/veggies#broccoli'>broccoli</a> to the pan with vinegar, garlic powder, onion powder, black pepper, and salt. Roast at 400F for about 30 minutes, or until fork tender and lightly charred

- Meanwhile, finely cut your <a href='/misc/veggies#cabbage'>cabbage</a>, and cut the <a href='/misc/veggies#onion'>onion</a> into a small dice
