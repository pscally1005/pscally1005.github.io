...
section3: Egg Wash
start4: Oat flour
section4: Breading (or use 100 g panko)
start5: Tomato
section5: Bruschetta
Prep: 30
Rest: 
...
- bruschetta
- brushetta
Description: An Italian style breaded chicken that's both gluten free and not deep fried sounds like a dream come true. This dish is elevated even more when made into Chicken Parmesan. It goes well with a side of Bruschetta mix, either on its own or on a slice of toasted Italian bread
Instructions:
...
- As the chicken cooks, you can make the Bruschetta topping. Finely dice the tomatoes, and add to a medium bowl. Season, and optionally serve on a slice of toasted bread, or spoon on top of the chicken<br><br>
