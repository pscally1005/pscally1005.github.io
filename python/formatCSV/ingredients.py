...
def ingredients(food):
    ...
    # Beans
        ...
        f = "Navy beans, drained and rinsed"
    elif food == "Navy beans, canned, whole" or food == "Cannellini beans, canned, whole":
        ...
        f = "Dried beans"
    elif food == "Split red lentils by ROYAL" or food == "Split red lentils by CEDAR PHOENICIA" or food == "Red lentils" or food == "Lentils, raw, pink or red" or food == "Lentils, raw":
        # f = "Red split lentils"
        f = "Lentils"
    ...
    elif food == "Cheese, brie":
        f = "Brie"
    elif food == "Cream cheese, fat free":
        # f = "Brie, fat free"
        f = "Cream cheese, fat free"
