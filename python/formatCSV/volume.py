...
def fix(vol):
    ...
    # tbsp
        ...
        v = "2 tbsp"
    elif vol == "7.5 tsp" or vol == "2.5 tbsp":
        v = "2 1/2 tbsp"
    ...
    # cup
        ...
        v = "1/2 cup + 2 tbsp"
    elif vol == "0.66675 cup" or vol == "0.695 cup, whole" or vol == "0.882 container" or  vol == "0.645 cup, unthawed" or vol == "0.88 3/4 cup" or vol == "0.66 cup, unthawed" or vol == "0.665 cup" or vol == "2/3 cup, unthawed" or vol == "0.9 3/4 cup" or vol == "0.67 cup" or vol == "0.66 cup" or vol == "0.66 cup (240.0 ml) aprx" or vol == "0.67 cup (240.0 ml) aprx" or vol == "32 tsp (5.0 ml) aprx" or vol == "0.6675 cup" or vol == "0.667 cup, chopped":
        v = "2/3 cup"
        ...
        v = "1 1/3 cup"
    elif vol == "72 tsp" or vol == "1.47 cup" or vol == "1.52 cup" or vol == "2.338 cup (not packed)" or vol == "2 container" or vol == "24 tbsp" or vol == "1.555 cup, NFS" or vol == "3.25 1/2 cup" or vol == "1.5 cup, chunks" or vol == "1.5 cup pieces" or vol == "2 3/4 cup":
        v = "1 1/2 cup"
        ...
        v = "2 1/4 cup"
    elif vol == "40 tbsp" or vol == "2.52 cup" or vol == "2.5 cup" or vol == "120 tsp":
        v = "2 1/2 cup"
    ...
    # lb
        ...
        v = "2 lb"
    elif vol == "3 pound" or vol == "3 lb" or vol == "48 oz" or vol == "48 ounce":
        v = "3 lb"
    elif vol == "4 pound" or vol == "4 lb" or vol == "64 oz" or vol == "64 ounce":
        v = "4 lb"
